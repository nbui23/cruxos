    ...
    <div className="space-y-8">
      <section className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
        <div className="rounded-[2rem] border border-white/10 bg-slate-900/80 p-8 shadow-2xl shadow-black/30">
          ...
          <div className="mt-6 rounded-3xl border border-cyan-400/20 bg-cyan-500/5 p-5">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/reports/performance" className="rounded-full bg-cyan-400 px-5 py-3 text-sm font-semibold text-slate-950">
              Open the insight report
            </Link>
            <Link href="/log" className="rounded-full border border-white/10 px-5 py-3 text-sm font-semibold text-slate-100">
              Log a new entry
            </Link>
          </div>
        </div>
